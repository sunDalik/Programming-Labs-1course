    ...
    public void load() {
        try {
            ...
            while (FileLoader.hasNext()) {
                seaList.add(new Sea(FileLoader.next(), Double.parseDouble(FileLoader.next()), FileLoader.nextInt(), Double.parseDouble(FileLoader.next()), Double.parseDouble(FileLoader.next()), FileLoader.next()));
            }
            FileLoader.close();
